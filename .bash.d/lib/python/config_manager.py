...
def load_env():
    ...
    export("DOCKER_REBOOT_MIN_TIMEOUT_SEC", dock_cfg.get("reboot_min_timeout_sec", 120))
    export("DOCKER_REBOOT_POLL_INTERVAL_SEC", dock_cfg.get("reboot_poll_interval_sec", 2))
